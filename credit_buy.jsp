            ...
            <div class="container">
			  ...
			  <div class="col-sm-8 col-md-9">
                            <div class="travelo-box">
							 ...
							 <ul id="tab">
           						 <li class="active">
               			     		  <h2 class="entry-title" style="color:black;">Account Details</h2>			
 


<a href="dootFormpage?parcel_type=parcel"><button style="background-color:#428bca; width:160px;font-size:15px;font-weight:bold; ">Available Balance</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=gift"><button style="background-color:#428bca; width:160px;font-size:15px;font-weight:bold;">Transaction History</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=parcel within taluk"><button style="background-color:#428bca; width:160px;font-size:15px;font-weight:bold;">Last 10 Transaction</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=parcel within taluk"><button style="background-color:#428bca; width:160px;font-size:15px;font-weight:bold;">Credits Purchased History</button></a>
								...
								<center>
								<tr>
       <form method="POST" action="${pageContext.request.contextPath}/payment" modelAttribute="tblcredit">
   
							
						
<select  name="gateway" style="width:200px;height:35px; align:center;font-size:15px;color:black;background-color:rgba(150, 164, 233, 0.45);">

...
<a href="dootFormpage?parcel_type=parcel"><button style="background-color:#428bca; width:150px;font-size:15px;font-weight:bold; ">Available Balance</button></a>&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=gift"><button style="background-color:#428bca; width:170px;font-size:15px;font-weight:bold;">Transaction History</button></a>&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=parcel within taluk"><button style="background-color:#428bca; width:170px;font-size:15px;font-weight:bold;">Last 10 Transaction</button></a>&nbsp;&nbsp;&nbsp;
<a href="dootFormpage?parcel_type=parcel within taluk"><button style="background-color:#428bca; width:215px;font-size:15px;font-weight:bold;">Credits Purchased History</button></a>
...
<c:forEach items="${map.accinfo}" var="user" varStatus="status">
<tbody>
                                              <tr>
                                              		<td>${user.s_firstname}</td>    
                                              		<td>${user.credit_points}</td>
                                              		<td><a href="${pageContext.request.contextPath}/credit_buy"><button>Buy</button></a>
                                              	</tr>
                                              		</tbody>
                </c:forEach>
																</table>
